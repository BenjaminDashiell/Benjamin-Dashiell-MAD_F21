...
final class animeDatabase{
    ...
    private init(){
        ...
        animeDB.append(Anime(animeTitle: "Scarlet Nexus", animeUIIV: UIImageView(image: UIImage(named: "testbg")),animeDate: "7-1-21",animeTime: "7:30 AM",currentAlertStatus: false))
